...
namespace project_quanlybanhang
{
    public partial class fHoadonnhap : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'qUANLY_CUAHANGMAYTINHDataSet31.NHANVIEN' table. You can move, or remove it, as needed.
            this.nHANVIENTableAdapter.Fill(this.qUANLY_CUAHANGMAYTINHDataSet31.NHANVIEN);
            comboBox1.Text = "Mã hóa đơn";
            
            //string sql = "select * from NHANVIEN";
            //string connString = "Data Source= LAPTOP-KNCJTSN8; Initial Catalog=QUANLY_CUAHANGMAYTINH; Integrated Security=True";
            //SqlConnection conn = new SqlConnection(connString);
            //SqlDataAdapter da = new SqlDataAdapter(sql, conn);
            //DataTable ds = new DataTable();
            //da.Fill(ds);
            //tenNVNhapHangComboBox.DataSource = ds;
            //tenNVNhapHangComboBox.DisplayMember = "TenNV";
            //tenNVNhapHangComboBox.ValueMember = "MaNV";
        ...
        {
            HDN = HDN + 1;
            maHDNTextBox.Text = "HDN" + HDN.ToString();
        }
    }
